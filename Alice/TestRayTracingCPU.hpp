...
namespace Test::RayTracingCPU
{
	...
	// Render Peter Shirley RayTracingInOneWeekend end scene.
	inline void RayTracingInOneWeekendSceneMotionBlur(const std::string path = "RayTracingInOneWeekendSceneMotionBlur.tga",uint32_t width = 400,uint32_t height = 200,uint32_t sampleTimes = 100)
	{
		using namespace Alice::RayTracingCPU;
		int nx = width;
		int ny = height;
